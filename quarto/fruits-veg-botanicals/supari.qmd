...
keywords: ["Areca nut", "Betel nut", "Paan", "Masticatory", "Areca catechu", "Traditional Indian chewing", "Oral health"]
description: "Supari, commonly known as the betel nut, is the seed of the Areca catechu palm, a plant with deep historical and cultural roots across South and Southeast Asia"
---

## History and Sourcing

[Supari](supari.qmd), commonly known as the betel nut, is the seed of the Areca catechu palm, a plant with deep historical and cultural roots across South and Southeast Asia. Its name, "supari," is derived from Hindi and Urdu, while its botanical origins trace back to the Sanskrit "poogiphala," signifying the fruit of the areca palm. Introduced to India millennia ago, the cultivation of areca palms is concentrated in the coastal and northeastern regions, particularly Karnataka, Kerala, Assam, West Bengal, and Maharashtra, where the humid tropical climate is ideal. Beyond its agricultural significance, supari holds a revered place in Indian traditions, featuring prominently in religious ceremonies, social rituals, and as a symbol of hospitality and auspiciousness.

## Home Kitchen Use

In traditional Indian homes, supari is not typically used as a culinary ingredient in cooked dishes but is primarily consumed as a masticatory. It is most famously chewed as part of 'paan,' a preparation involving a betel leaf (paan patta) wrapped around supari, slaked lime (chuna), and catechu (kattha), often with other spices and sweeteners. This practice is deeply ingrained in social customs, offered to guests as a gesture of welcome, and traditionally believed to aid digestion and act as a mouth freshener. [Supari](supari.qmd) can be consumed raw, dried, fermented, or roasted, and is available in various cuts and forms, from whole nuts to finely shredded pieces.
