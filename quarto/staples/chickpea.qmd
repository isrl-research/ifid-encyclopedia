...
keywords: ["Chickpea", "Chana", "Besan", "Kabuli Chana", "Desi Chana", "Legume", "Dal", "Indian cuisine", "Protein"]
description: "The chickpea, known in India primarily as *chana* (चना) or *chole* (छोले), boasts an ancient lineage, with archaeological evidence tracing its origins to the..."
---
